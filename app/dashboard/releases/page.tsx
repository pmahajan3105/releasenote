...
export default function ReleasesPage() {
    ...
    const releaseNotes = useReleaseNotesStore((state) => state.releaseNotes) as ReleaseNote[]
    ...
    const handleAction = (action: string, releaseNote: ReleaseNote, _data?: unknown) => {
        switch (action) {
            case 'edit':
                    ...
                    {loading ? (
                        ...
                        <Card>
                            <CardContent className="pt-6 text-center py-12">
                                <EmptyState
                                    icon={<PlusIcon className="w-10 h-10 mx-auto" />}
                                    headline={searchTerm ? 'No matching release notes' : 'No release notes yet'}
                                    subtext={
                                        searchTerm
