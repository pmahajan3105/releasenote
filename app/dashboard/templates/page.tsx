...
function TemplateForm({ template, onSave, onCancel }: {
    ...
    return (
        <div className="space-y-3">
            ...
            {showAdvanced && (
                <div className="space-y-3">
                    <Input name="id" placeholder="ID (optional)" value={form.id || ""} onChange={handleChange} />
...
export default function TemplateManagementPage() {
    ...
    useEffect(() => {
        const fetchTemplates = async () => {
            ...
            try {
                ...
                const json = (await res.json()) as { templates: AITemplate[]; error?: string }
    ...
    const handleDelete = async (id: string) => {
        try {
            ...
            const json = (await res.json()) as { template?: AITemplate; error?: string }
    ...
    const handleSave = async (t: AITemplate) => {
        let res: Response
        let json: { template?: AITemplate; error?: string }
